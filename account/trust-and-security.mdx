...
What analytics collect about a visit to Labrador's public pages depends on the choice made in the cookie banner:

- If you accept, the visit is measured with cookies and the session is recorded, so Labrador can see how the pages are used.
- If you decline, or never answer the banner, the visit is counted anonymously. No identifying data is stored on your device, and the session is not recorded.
