...
description: "Switch to dark mode, update your password, manage active sessions, configure two-factor authentication, and control billing from your Labrador account settings."
---
...
Labrador has a dark theme. Open the account menu in the top-right corner of any page and choose **Dark mode** to switch; choose it again to go back to light. The menu stays open as you switch so you can see the change happen.

Two things worth knowing:

- **It applies to the app, not the marketing site.** Projects, audits, account, billing, notifications, and admin pages all follow your choice. Public pages such as the homepage and pricing stay light by design.
- **The setting is saved in the browser you set it in.** It is not tied to your account, so switching to dark on your laptop will not carry across to a different computer or a private window. Set it once per browser.
