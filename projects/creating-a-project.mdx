...
Deleting a project is irreversible. It removes the project's pages, user journeys, test results, issues, comments, and attachments, and none of it can be recovered. Export any reports you need before you start.

Because there is no undo, Labrador asks you to type a word to confirm.

<Steps>
  <Step title="Start the deletion">
    From your **Projects** dashboard, choose to delete the project you want to remove. A confirmation dialog appears, spelling out that the action is irreversible and listing everything it removes.
  </Step>
  <Step title="Type delete to confirm">
    Type `delete` into the confirmation field. The **Delete** button stays greyed out and inactive until the field matches, and pressing Enter in the field does not delete anything.
  </Step>
  <Step title="Click Delete">
    Click **Delete**. The button reads **Deleting…** while the deletion runs. If it fails, the dialog stays open and shows the error, so you can try again or cancel.
  </Step>
</Steps>
