...
<CardGroup cols={2}>
  ...
  <Card title="VPAT® 2.5 – WCAG 2.2" icon="file-contract">
    Use this methodology when you need to produce a formal Voluntary Product Accessibility Template — for example, for government procurement, enterprise vendor assessments, or clients who require VPAT documentation.
...
<Info>
  If you are unsure which methodology to choose, ask your client whether they need a VPAT document delivered. If they do, select VPAT® 2.5 – WCAG 2.2. For all other engagements, WCAG 2.2 AA Testing is the right starting point.
</Info>
