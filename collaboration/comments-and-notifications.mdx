...
<Note>
  Comments and criterion-level notifications are available on Plus and Enterprise plans. Upgrading from Core unlocks team commenting and the full notifications system.
</Note>
...
<Steps>
  <Step title="Navigate to the issue or criterion result">
    Open the project, select the relevant page or component, and click through to the issue or criterion result you want to comment on.
  </Step>
  <Step title="Find the Comments section">
    Scroll to the **Comments** section within the issue or criterion view. This appears below the issue details and any attached media.
  </Step>
