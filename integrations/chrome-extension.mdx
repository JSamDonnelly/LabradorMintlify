---
title: "Labrador Chrome extension: axe scans and AI accessibility remediation"
sidebarTitle: "Chrome extension"
description: "Capture live page HTML with the Labrador Chrome extension and generate AI-powered accessibility remediation guidance for your issues using Claude Fable 5.1."
---
...
- **AI remediation guidance**, click a specific element on the page to capture its HTML and generate developer-ready fix suggestions from Claude Fable 5.1.
...
<Steps>
  ...
  <Step title="Trigger an axe scan">
    ...
    **Batch mark N/A** sits next to it. That one needs no extension and is worth a moment before or after scanning: it marks whole groups of criteria as not applicable based on what the page does not contain. See [the N/A batch tool](/projects/auditing-criteria#the-na-batch-tool).
  </Step>
...
The recommendation Claude Fable 5.1 produces is designed to give developers the context they need to fix the issue without requiring additional back-and-forth.
