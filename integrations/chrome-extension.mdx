---
title: "AI Remediation with the Labrador Chrome Extension"
sidebarTitle: "Chrome Extension"
description: "Install the Labrador Chrome extension to capture live page HTML and generate AI-powered remediation guidance for accessibility issues using Claude Opus."
---

The Labrador Chrome extension bridges the gap between your audit in Labrador and the live page you are testing. When you click a specific element on the page, the extension captures that element's HTML and sends it back to Labrador. Labrador then combines the captured HTML with your issue description and the WCAG criterion being tested to generate developer-ready remediation guidance, powered by Claude Opus. The result appears directly inside the issue under **Remediation Help**, ready for you to review, refine, and include in your exported report.
...
The recommendation Claude Opus produces is designed to give developers the context they need to fix the issue without requiring additional back-and-forth.
