...
description: "Capture live page HTML with the Labrador Chrome extension and generate AI-powered accessibility remediation guidance for your issues using Claude Opus 5.5."
---
...
- **AI remediation guidance**, click a specific element on the page to capture its HTML and generate developer-ready fix suggestions from Claude Opus 5.5.
...
The recommendation Claude Opus 5.5 produces is designed to give developers the context they need to fix the issue without requiring additional back-and-forth.
