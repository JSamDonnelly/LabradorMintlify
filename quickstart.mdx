---
title: "Get Started with Labrador Accessibility Testing"
sidebarTitle: "Quickstart"
description: "Create your first accessibility audit project in Labrador, add a page to test, evaluate WCAG criteria, and export a report — in five steps."
---
